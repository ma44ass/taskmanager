...
Application de gestion de tâches avec une architecture **REST**, développée sous **Ubuntu** et sécurisée par une couche de validation de données **Zod**.

## 🛠️ Fonctionnalités & Implémentation
